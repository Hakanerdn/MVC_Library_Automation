...
namespace MVC_Library_Automation.Controllers
{
    public class NoticeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Announcement,Description,Date")] Notice notice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Announcement,Description,Date")] Notice notice)
        {
            if (ModelState.IsValid)
            {
